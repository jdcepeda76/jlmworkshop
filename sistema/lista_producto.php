...
<body>
	...
	<section id="container">
		...
		<a href="reports/reporte_allproducts.php" class="btn_excel"><i class="fas fa-file-excel"></i> Exportar</a>
	<div class="containerTable">
		<table>
			...
			<?php  
				...
				//PAGINADOR
				$sql_registe = mysqli_query($conection,"SELECT COUNT(*) AS total_registro FROM productos WHERE estatus = 1");
				...
				$query = mysqli_query($conection,"SELECT p.Id_producto, p.producto, pr.nombre, p.precio, p.cantidad, te.tela, ta.codigo, p.foto
													 ...
													 WHERE p.estatus = 1 ORDER BY p.Id_producto DESC LIMIT $desde,$por_pagina ");
