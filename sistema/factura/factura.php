...
<div id="page_pdf">
	...
	<div>
		<p class="nota">Si usted tiene sugerencias sobre su factura, <br>pongase en contacto con nombre y teléfono</p>
		<h4 class="label_gracias">¡Gracias por su pedido!</h4>
	</div>
